...
export default function SingleRocket({ id, closeModal }) {
    ...
    <>
      {!singleRocket ? (
        ...
        <section className='py-32 max-width grid grid-cols-1 gap-8 md:grid-cols-2'>
          <article data-testid='rocket-details-modal'>
            ...
            <div className='grid grid-cols-1 gap-5 md:grid-cols-2 text-white opacity-75'>
              <ul>
                <li>Cost per launch: {singleRocket.cost_per_launch.toLocaleString()} USD</li>
            ...
            <ul className='flex items-center justify-start gap-3 mt-5'>
              <li>
                <a href={singleRocket.wikipedia} target='_blank' rel='noreferrer' className='btn'>
                  Wikipedia
                </a>
              </li>
              <li>
              ...
              <li>
                <div
                  onClick={closeModal}
                  className='text-white opacity-75 text-sm hover:opacity-100 cursor-pointer'
                >
                  &larr; Back
                </div>
              </li>
